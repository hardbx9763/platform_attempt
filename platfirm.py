...
gameIcon = pygame.image.load('coin.png')
...
font_score = pygame.font.SysFont('Futura', 30)
...
class Player():
        ...
        if game_over == 0:
            ...
            for platform in platform_group:
                ...
                if platform.rect.colliderect(self.rect.x, self.rect.y + dy, self.width, self.height):
                    ...
                    if abs((self.rect.top + dy) - platform.rect.top) < col_thresh:
                        self.vel.y = 0
                        dy = platform.rect.top - self.rect.top
                    #check if above platform
                    elif abs((self.rect.bottom + dy) - platform.rect.bottom) < col_thresh:
                        self.rect.bottom = platform.rect.top - 1
                        self.in_air = False
                        dy = 0
                    #move sidways with the platform
         ...
         draw_text("Game Over",font,blue,(screen_width//2) - 40,screen_height/2)
         if self.rect.y >200:
            self.rect.y -= 5
    ...
    def reset(self,x,y):
        ...
        self.deadimage = pygame.image.load("ghost.png")
...
#create dummy coin for shopwing the score
...
while run:
    ...
    if game_over == 0:
     ...
     #Update score
     #Check to see if a coin has been collected
